...
string[] weapon = { "magic wand", "plastic fork", "banana", "brick", "sword" };


//string[] heroes = { "Harry Potter", "Lara Croft", "Luke Skywalker", "Hermonie Granger" };
//string[] villains = { "Lord Voldemort", "Joker", "Dracula", "Darth Vader", "Sauron" };
...
{
    Console.WriteLine($"{villain} side wins!");
}
else
{
